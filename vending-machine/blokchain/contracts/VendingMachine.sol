...
contract VendingMachine {
    ...
    function restock(uint amount) public {
        ...
        donutBalances[address(this)] += amount; //just updates stock with an arbitrary amount, doesnt take away any dougnuts purchased
    }

    // Purchase donuts from the vending machine
    function purchase(uint amount) public payable {
        require(msg.value >= amount * 0.005 ether, "You must pay at least 2(changed to 0.005) ETH per donut");
